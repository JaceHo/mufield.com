...
from apps.friendship.exceptions import AlreadyExistsError
from apps.friendship.signals import friendship_request_created, \
...
class Follow(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        bust_cache('followers', self.followee.pk)
        bust_cache('following', self.follower.pk)
